...
[NOTE]
====
Manila no tiene empaquetada la integración con Horizon. En estos casos descargaremos los fuentes, los procesaremos y los integraremos en Horizon.
====
...
. Delete manila.sqlite on storage
...
. Crear volúmenes compartidos con `Shared File Systems` de tipo `DHSS = False`
